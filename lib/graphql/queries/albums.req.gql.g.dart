...
class _$GAlbumsReq extends GAlbumsReq {
  ...
  factory _$GAlbumsReq([void Function(GAlbumsReqBuilder)? updates]) =>
      (new GAlbumsReqBuilder()..update(updates)).build();
  ...
  _$GAlbumsReq._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, 'GAlbumsReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(operation, 'GAlbumsReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, 'GAlbumsReq', 'executeOnListen');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GAlbumsReq')
          ..add('vars', vars)
    ...
    try {
      _$result = _$v ??
          new _$GAlbumsReq._(
              ...
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, 'GAlbumsReq', 'operation'),
              requestId: requestId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'GAlbumsReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
